...
const Bento = ({ slice }: BentoProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:gap-10 md:grid-cols-3">
        {slice.items.map((item, index) => (
          <div key={index}
            className={clsx("glass-container row-span-3 grid grid-rows-subgrid gap-4 rounded-lg bg-gradient-to-b from-gray-900 to-gray-950 p-4",
