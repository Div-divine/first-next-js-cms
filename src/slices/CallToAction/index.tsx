...
const CallToAction = ({ slice }: CallToActionProps): JSX.Element => {
  return (
    ...
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-sm rounded-full 
      bg-blue-500/50 blur-[160px] filter" />
      <div className="glass-container rounded-lg bg-gradient-to-b from-slate-800 to-slate-900 p-4">
        <PlainLogo />
      </div>
