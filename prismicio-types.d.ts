...
interface SettingsDocumentData {
  ...
  /**
   * Falback OG Image field in *settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.falback_og_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  falback_og_image: prismic.ImageField<never>;
...
export interface IntegrationsSliceDefaultItem {
  ...
  icon: prismic.SelectField<
    "cloudflair" | "npm" | "github" | "figma" | "digitalocean" | "fly"
  >;
}
...
export interface ShowcaseSliceDefaultPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<"gear" | "circle">;
